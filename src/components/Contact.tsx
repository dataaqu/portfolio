    ...
    <section className="relative min-h-screen w-full bg-black flex items-center justify-center py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          ...
          >
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-[#405DE6] via-[#833AB4] to-[#FD1D1D] rounded-full flex items-center justify-center p-0.5 group-hover:shadow-lg transition-all">
